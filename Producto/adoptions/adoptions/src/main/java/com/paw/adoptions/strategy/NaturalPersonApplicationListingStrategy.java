...
public class NaturalPersonApplicationListingStrategy implements ApplicationListingStrategy {

    private final AdoptionApplicationRepository applicationRepository;

    @Override
    public UserRole supportedRole() {
        return UserRole.NATURAL_PERSON;
    }

    @Override
    public List<AdoptionApplication> findApplications(UUID userId) {
        return applicationRepository.findByPersonIdOrderByCreatedAtDesc(userId);
    }
}
