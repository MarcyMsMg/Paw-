...
public class NotificationsClient {
    ...
    public NotificationsClient(
            ...
            @Value("${paw.services.notifications.base-url:http://localhost:8086/api}") String notificationsBaseUrl,
            @Value("${paw.services.notifications.internal-api-key:${paw.services.users.internal-api-key:}}") String internalApiKey
    ) {
